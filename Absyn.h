...
struct Function_
{
  enum { is_Global, is_Fun } kind;
  union
  {
    struct { Ident ident_; Type type_; } global_;
    struct { Ident ident_; ListDecl listdecl_; ListStm liststm_; Type type_; } fun_;
  } u;
};

Function make_Global(Type p0, Ident p1);
...
struct Stm_
{
  enum { is_SDecl, is_SExp, is_SBlock, is_SIf, is_SIfElse, is_SFor, is_SWhile, is_SReturn } kind;
  union
  {
    ...
    struct { Exp exp_1, exp_2, exp_3; Stm stm_; } sfor_;
...
Stm make_SFor(Exp p0, Exp p1, Exp p2, Stm p3);
